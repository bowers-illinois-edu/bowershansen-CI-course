...
```{r doresdirectparallel, cache=TRUE}
library(parallel)
...
## Did we adjust enough? Assessing extrapolation/interpolation problems.
...
## Evaluate the matched design: Within set differences
...
## Evaluate the matched design: Compare to a randomized experiment.
