...
results1o <- results1[order(results1$x),]
...
with(results1o,{
       plot(x,d2p,xlab="PS Caliper",ylab="d2 p")
...
Here I demonstrate searching for two calipers, and requiring no more than 1 treated unit per set (to maximize effective sample size).
...
lm1a <- lm(HomRate08~nhTrt,data=meddat,weights=hbwt)
