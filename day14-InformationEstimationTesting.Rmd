...
## Today
  ...
  1. Agenda: How to characterize the information in a matched design (use what
     ...
     experiments) `effective sample size`; Estimating and testing using matched
     designs.
...
balfmla <- reformulate(thecovs[-1], response = "nhTrt")
...
Notice for `fm0` we weight the 8-to-1 match by `2*(1 * 8)/(8+1)=1.78` and the 1-to-16 match by `2*(16*1)/(16+1)=1.88`.
