...
\addbibresource{matching_guide_extra.bib}
...
The course schedule is below; the Course content section gives fuller readings for each topic, along with the menu of student-chosen special topics for the final day. Everything through June 19 concerns randomized experiments; the June 22 session extends these ideas to experiments with noncompliance and attrition, after which the course turns to observational studies.
...
Tues, June 16 & Tom & \begin{tabular}{@{}l@{}} The sharp framework: \\ Fisherian inference \end{tabular} & \begin{tabular}{@{}c@{}} Rosenbaum (2017, Chapter 3) \\ Fisher (1935, \S~5--10) \end{tabular} & \multirow{3}{*}{Arceneaux (2005)} \\ \cline{1-4}
  Wed, June 17 & Tom & \begin{tabular}{@{}l@{}} Weak framework I: \\ Estimating average effects \end{tabular} & \begin{tabular}{@{}c@{}} Gerber and Green (2012, Ch.~2 and pp.~51--61) \\ Aronow and Middleton (2013) \\ Middleton and Aronow (2015) \end{tabular} & ~ \\ \cline{1-4}
Thurs, June 18 & Tom & \begin{tabular}{@{}l@{}} Weak framework II: Variance and conservative \\ inference; covariance adjustment \end{tabular} & \begin{tabular}{@{}c@{}} Gerber and Green (2012, Ch.~3--4) \\ Freedman et al.\ (1998) \\ Imbens and Rubin (2015, pp.~87--98) \\ Rosenbaum (2002); Lin (2013) \end{tabular} & ~ \\ \hline
...
\subsection{The weak framework I: Estimating average effects}
...
\subsection{The weak framework II: Variance and conservative inference}
...
\begin{verse} \fullcite{leavitt2026} \end{verse}

\subsubsection{Regression discontinuity designs and ``natural experiments''}\label{sec:nat_exp}
...
\begin{verse} \fullcite{leavitt2024} \end{verse}
