...
\hypersetup{
  ...
  pdfauthor = {Ben Hansen, Jake Bowers, Thomas Leavitt}
}
...
\author{%
  ...
  Ben Hansen\textsuperscript{2} \and
  Thomas (Tom) Leavitt\textsuperscript{3}
}
...
\begin{center}\small
  ...
  \textsuperscript{2}Department of Statistics, University of Michigan, Ann Arbor;
  \texttt{bbh@umich.edu}\\
  \textsuperscript{3}Marxe School of Public and International Affairs,
...
\begin{table}[!htbp]
\caption{Course schedule by date, instructor, topic, readings, and application}
\centering
...
Mon, June 16 & Tom & Introduction: Random allocation and Fisher's exact test
                      & \begin{tabular}{@{}c@{}}
                                              Kinder
                                              and Palfrey (1993,
                                              Section 1.2) \\ Fisher
...
Tues, June 17 & \multirow{2}{*}{Tom} & \multirow{2}{*}{Randomized experiments: Potential
                                        outcome schedules and estimation of causal
                                        effects}
                                                     & \begin{tabular}{@{}c@{}}
                                                         Fisher (1935,
                                                         \S~5--10 on pp.11--19\\
...
\\Holland (1986, \S~1--3) \\
  ...
  Wed, June 18 & Tom & Differences of means and average causal effects & Gerber and Green (2012, Ch. 2 and
                             \S~1--4 of Ch.3) & ~ \\ \cline{1-4}
  Thurs, June 19 & -- &  No Class: Juneteenth U.S. Holiday & & ~ \\ \cline{1-4}
Fri, June 20 (HW 1 due) & Tom & Randomized experiments: covariance adjustment and regression & \begin{tabular}{@{}c@{}} Gerber and Green (2012, Chapter 4) \\ Rosenbaum (2002) \\ Lin (2013) \end{tabular} & ~ \\ \hline
Mon, June 23 & Tom & \multirow{2}{*}{Randomized experiments: Noncompliance and attrition} & \begin{tabular}{@{}c@{}} Gerber and Green (2012, Chapters 5 -- 6) \\ Rosenbaum (1996) \\ Rosenbaum (2010, Section 5.3)\end{tabular} & \multirow{2}{*}{Albertson and Lawrence (2009)} \\ \cline{1-5}
Tues, June 24 & Tom & Observational studies: Introduction & \begin{tabular}{@{}c@{}} Bind and Rubin (2019) \\ Gelman and Hill (2006, Sections 9.0 -- 9.2) \\ Berk (2010) \end{tabular} &  \\ \cline{1-4}
  Wed, June 25 & Tom Jake & Introduction to matching & Rosenbaum (2017, pp. 65 -- 90); Hansen and Bowers (2008)  & ~ \\ \cline{1-4}
Thurs, June 26  & Tom & Nuts and bolts of matching & \begin{tabular}{@{}c@{}} Rosenbaum (2010, Chapters 7 -- 8) \\ Rosenbaum (2017, Chapter 11) \end{tabular} & \multirow{6}{*}{Cerd\'{a} et al (2012)} \\ \cline{1-4}
Fri, June 27 (HW 2 due) & Tom & Multivariate matching with propensity scores & \begin{tabular}{@{}c@{}} Rosenbaum (2017, pp. 90 -- 96) \\ Hansen (2011) \end{tabular} & ~ \\ \cline{1-4}
...
Thurs, July 3 (HW 3 due) & Jake & Sensitivity analysis elaborations and
...
\subsection{Nuts and bolts of matching}
