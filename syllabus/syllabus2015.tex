...
\input{../authoranddate} %misnomer, as of now file only carries date
...
robust to weak instruments, spillover and interaction effects, heterogeneous treatment effects,
...
(\url{http://umich.instructure.com}).  
% (To use Canvas,
