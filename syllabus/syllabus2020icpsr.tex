...
\section{"Controlling for" in observational studies}
\paragraph*{Required}

\begin{verse}   \bibentry{gelman2007dau} (Chap 9.0--9.2 on causal inference and especially interpolation and extrapolation) \end{verse}

  \bibverse{berk2010you}

  \paragraph*{Recommended}

  \begin{verse}  \bibentry{achen:2002} (on the problem of kitchen sink regressions) \end{verse}

  \begin{verse}  \bibentry{fox2008applied} (Chap 11 and Chap 19 on Overly Influential Points) \end{verse}
...
\nobibliography{../BIB/Master_Bibliography}
