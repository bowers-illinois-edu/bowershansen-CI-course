...
After showing them this, STOP and have them do \S~1--3 of worksheet;
do exercises 1 and 2 at the end of section~3.  
(At \url{http://www.stat.lsa.umich.edu/~bbh/cscarworksheet.pdf}.)
...
\begin{tikzpicture}[overlay]
 ...
 \end{tikzpicture}
\begin{semiverbatim}
pairmatch( match\_on(pr \textasciitilde\ date+cap, data=nuke.nopt) )

\textrm{\textit{or}}\, \, pairmatch( pr \textasciitilde\ date+cap, data=nuke.nopt ) 
\end{semiverbatim}
