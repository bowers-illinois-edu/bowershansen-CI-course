...
\date{June 22, 2026} % Date, can be changed to a custom date
...
\begin{frame}[t]{Days 4--5: inference for the average effect}
\vfill
\begin{itemize} \vfill
...
\begin{figure}[H]
\centering
\includegraphics[height=0.78\textheight]{hansen_bowers_2009.png}
\end{figure}
\vspace{-0.6em}
