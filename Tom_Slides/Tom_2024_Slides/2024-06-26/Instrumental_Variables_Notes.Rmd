...
\end{align*}
The assumption of No Defiers implies that $\pi^{\textrm{D}} = 0$; hence, $\text{ITT}_D = \pi^{\textrm{C}}$.
...
\begin{align*}
\pi^{\textrm{C}} \tau^{\textrm{C}}.
\end{align*}

Then, invoking the expression for the $\textrm{ITT}_D$, it follows that the ratio of $\textrm{ITT}_Y$ to $\textrm{ITT}_D$ is
\begin{align*}
\dfrac{\textrm{ITT}_Y}{\textrm{ITT}_D} = \dfrac{\pi^{\textrm{C}} \tau^{\textrm{C}}}{\pi^{\textrm{C}}} = \tau^{\textrm{C}},
\end{align*}
which is the CACE.
