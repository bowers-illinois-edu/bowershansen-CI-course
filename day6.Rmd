...
## Assessing the Intent to Treat Effect (ITT)

The ITT is defined as $\bar{y}_T - \bar{y}_C$ where $y_T$ is the potential
outcome to treatment, and $y_C$ is the potential outcome to control. 

Why give it a new name?
\smallskip
What evidence do we have against the claim that the policy had no effects?
\smallskip
What is our best guess about the ITT itself?
