...
library('devtools')
library('withr')
with_libpaths(here::here('libraries'), install_github("markmfredrickson/RItools",force=TRUE), 'pre')
```
...
course, Statistical Inference and Causal Inference, Instrumental Variables or Encouragement Designs.
 2. Reading: @angrist1996 including the @rosenbaum1996 discussion; @gerbergreen2012, Chapter 5.
...
Name, Organization/Affiliation, Research Interest
