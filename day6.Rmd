...
# But first: An overview of approaches to statistical inference for causal quantities
...
# And second, some more context: The creation of interpretable comparisons.
...
## Research designs to aid the creation of interpretable comparisons
   ...
   - Semi-/Non-parametric Covariance Adjustment ($Z$ out of our control, but we can choose how to organize and observe) (matching and difference-in-differences)
