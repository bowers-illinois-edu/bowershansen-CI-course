...
## Defining our causal effects
 ...
 - $d_{i,Z_i=1}$ means that person $i$ opened the door to have a conversation when assigned a visit. Opening the door is an outcome of the treatment, is caused by the treatment.
 ...
 - $y_{i,Z_i = 0, d_{i,Z_i=1}=1}$ is the potential outcome for people who were not assigned a visit and who opened the door.
 - $y_{i,Z_i = 0, d_{i,Z_i=1}=0}$ is the potential outcome for people who were not assigned a visit and who would not have opened the door.
...
sum of the responses to treatment $p(d_1=1)$ is the proportion of people
opening their doors minus the response to assignment to control.
...
Average Treatment Effect): CACE$= \bar{y_{i,Z=1,d_1=1}} - \bar{$

\begin{align*}
ITT & = ( \bar{y}_{Z=1,d_1=1}p(d_1=1) + \bar{y}_{Z=1,d_1=0}(1-p(d_1=1)) )  - \bar{y}_{Z=0} \\
    & = ( \bar{y}_{Z=1,d_1=1}p(d_1=1) + \bar{y}_{Z=1,d_1=0}(1-p(d_1=1)) )  - ( \bar{y}_{Z=0,d_1=1}p(d_0=1) + \bar{y}_{Z=0,d_1=0}(1-p(d_0=1)) ) 
   & = ( \bar{y}_{Z=1,d_1=1}p(d_1=1) + \bar{y}_{Z=1,d_1=0} - \bar{y}_{Z=1,d_1=0}p(d_1=1) )  - 

( \bar{y}_{Z=0,d_1=1}p(d_0=1) + \bar{y}_{Z=0,d_1=0} - \bar{y}_{Z=0,d_1=0}p(d_0=1) ) \\
\intertext{but $p(d_0=1)=0$
...
## Summary of the Day
  ...
  - The ITT and CACE/LATE represent different causal effects.
