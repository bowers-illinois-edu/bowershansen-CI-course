...
lmD1<-lm(baddays_phys_12m ~ treatment, data = OHIE_filtered, subset = ohp_all_ever_admin == 1 & numhh_list=="signed self up")
lmD0<-lm(baddays_phys_12m ~ treatment, data = OHIE_filtered, subset = ohp_all_ever_admin == 0 & numhh_list=="signed self up")
