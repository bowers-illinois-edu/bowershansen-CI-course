...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs\_test\_stat }\OtherTok{\textless{}{-}} \FunctionTok{treat\_group\_mean}\NormalTok{(}\AttributeTok{.Z =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{z, }\AttributeTok{.y =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{null\_test\_stats }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(}\AttributeTok{n =} \DecValTok{10}\SpecialCharTok{\^{}}\DecValTok{3}\NormalTok{, }\AttributeTok{expr =} \FunctionTok{treat\_group\_mean}\NormalTok{(}\AttributeTok{.Z =} \FunctionTok{sample}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z),}
    \AttributeTok{.y =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03))}

\NormalTok{null\_test\_stat\_dist }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{null\_test\_stat =}\NormalTok{ null\_test\_stats)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# t() is to transpose a matrix; \%*\% is the matrix multiplication operator}
\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z)) }\SpecialCharTok{*} \FunctionTok{t}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z) }\SpecialCharTok{\%*\%}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pop\_mean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{vote03)}

\NormalTok{pop\_var }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((acorn\_data}\SpecialCharTok{$}\NormalTok{vote03 }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{vote03))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}

\FunctionTok{cbind}\NormalTok{(pop\_mean, pop\_var)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fpc\_var\_sample\_mean }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(.y, .n\_1) \{}

\NormalTok{    (.n\_1}\SpecialCharTok{\^{}}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{*}\NormalTok{ ((}\FunctionTok{length}\NormalTok{(.y) }\SpecialCharTok{{-}}\NormalTok{ .n\_1)}\SpecialCharTok{/}\FunctionTok{length}\NormalTok{(.y)) }\SpecialCharTok{*}\NormalTok{ (}\FunctionTok{sum}\NormalTok{((.y }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(.y))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{length}\NormalTok{(.y) }\SpecialCharTok{{-}}
        \DecValTok{1}\NormalTok{)}

\NormalTok{\}}

\NormalTok{fpc\_var }\OtherTok{\textless{}{-}} \FunctionTok{fpc\_var\_sample\_mean}\NormalTok{(}\AttributeTok{.y =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03, }\AttributeTok{.n\_1 =} \FunctionTok{sum}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim\_error }\OtherTok{\textless{}{-}}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(null\_dist\_sim\_var }\SpecialCharTok{{-}}\NormalTok{ fpc\_var)}\SpecialCharTok{/}\NormalTok{fpc\_var) }\SpecialCharTok{*} \DecValTok{100}
\NormalTok{sim\_error}
\end{Highlighting}
\end{Shaded}
...
\begin{align*}
\left(\frac{\left|\mathrm{Var}_{sim}\left[n_1^{-1} \mathbf{Z}^{\prime} \mathbf{y}\right] - \mathrm{Var}\left[n_1^{-1} \mathbf{Z}^{\prime} \mathbf{y}\right]\right|}{\mathrm{Var}\left[n_1^{-1} \mathbf{Z}^{\prime} \mathbf{y}\right]}\right) 100 \approx 0.085 \%.
\end{align*}
...
\begin{align*}
\Omega_{C} & = \left\{ \mathbf{z}: \sum \limits_{i = 1}^n z_i = n_1 \right\} = \left\{ \ \begin{bmatrix} 1 \\ 1 \\ 1 \\ 0 \\ 0 \\ 0 \end{bmatrix}, \ \begin{bmatrix} 1 \\ 1 \\ 0 \\ 1 \\ 0 \\ 0 \end{bmatrix}, \ \cdots , \ \begin{bmatrix} 0 \\ 0 \\ 1 \\ 0 \\ 1 \\ 1  \end{bmatrix}, \ \begin{bmatrix} 0 \\ 0 \\ 0 \\ 1 \\ 1 \\ 1  \end{bmatrix} \ \right\}.
\end{align*}
