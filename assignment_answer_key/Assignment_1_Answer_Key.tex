...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs\_test\_stat }\OtherTok{\textless{}{-}} \FunctionTok{treat\_group\_mean}\NormalTok{(}\AttributeTok{.Z =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{z,}
...
\NormalTok{null\_test\_stats }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(}\AttributeTok{n =} \DecValTok{10}\SpecialCharTok{\^{}}\DecValTok{5}\NormalTok{,}
                             \AttributeTok{expr =} \FunctionTok{treat\_group\_mean}\NormalTok{(}\AttributeTok{.Z =} \FunctionTok{sample}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z),}
                                                     \AttributeTok{.y =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03))}
...
\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z)) }\SpecialCharTok{*}
  \FunctionTok{t}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z) }\SpecialCharTok{\%*\%}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{pop\_var }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((acorn\_data}\SpecialCharTok{$}\NormalTok{vote03 }\SpecialCharTok{{-}}
                   \FunctionTok{mean}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{vote03))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}

\FunctionTok{cbind}\NormalTok{(pop\_mean,}
\NormalTok{      pop\_var)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fpc\_var\_sample\_mean }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(.y,}
\NormalTok{                                .n\_1) \{}
  
\NormalTok{  (.n\_1}\SpecialCharTok{\^{}}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{*}\NormalTok{ ((}\FunctionTok{length}\NormalTok{(.y) }\SpecialCharTok{{-}}\NormalTok{ .n\_1)}\SpecialCharTok{/}\FunctionTok{length}\NormalTok{(.y)) }\SpecialCharTok{*}
\NormalTok{    (}\FunctionTok{sum}\NormalTok{((.y }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(.y))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{length}\NormalTok{(.y) }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}
  
\NormalTok{\}}

\NormalTok{fpc\_var }\OtherTok{\textless{}{-}} \FunctionTok{fpc\_var\_sample\_mean}\NormalTok{(}\AttributeTok{.y =}\NormalTok{ acorn\_data}\SpecialCharTok{$}\NormalTok{vote03,}
                               \AttributeTok{.n\_1 =} \FunctionTok{sum}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z))}
