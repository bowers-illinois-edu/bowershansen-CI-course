...
\NormalTok{null\_test\_stats }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(}\AttributeTok{n =} \DecValTok{10}\SpecialCharTok{\^{}}\DecValTok{5}\NormalTok{, }\AttributeTok{expr =} \FunctionTok{treat\_group\_mean}\NormalTok{(}\AttributeTok{.Z =} \FunctionTok{sample}\NormalTok{(acorn\_data}\SpecialCharTok{$}\NormalTok{z),}
