...
\begin{align*}
\left|p_{\text{approx}} - p_{\text{exact}}\right| & \leq 0.005 \\
\frac{1}{\sqrt{n_{\text{sims}}}} & \leq 0.005 \\ 
\frac{1}{n_{\text{sims}}} & \leq 0.000025 \\ 
\frac{1} & \leq 0.000025 n_{\text{sims}} \\ 
\\frac{1}{0.000025} & \leq \frac{1}{\sqrt{n_{\text{sims}}}} \\
