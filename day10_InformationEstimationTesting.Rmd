...
## Today
 ...
 1. Agenda:
   a. How to characterize the information in a matched design (use what we know about the variance of estimators from block-randomized experiments); what does `effective sample size` mean?
