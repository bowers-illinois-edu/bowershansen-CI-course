...
\begin{frame}{Example 2: \sout{Did ideological innocence end in 1964?}
  The Perry Preschool project}

As the Coalition for Evidence-Based Policy describes it:
\begin{columns}
...
\begin{itemize}
\item[Intervention] A high-quality preschool for children from
  disadvantaged backgrounds.
\item[Methods] Randomized controlled trial shows major impact on educational and life outcomes; we note, however, that this was a demonstration project, and it is not yet known if the results can be replicated on a broader scale in typical classroom settings. 
\end{itemize}
  
\end{Column}
\end{columns}
(\url{http://evidencebasedprograms.org/1366-2/65-2}.  The Perry
Preschool is in Ypsilanti, MI, just 7 miles to the east of UM. )
  
\end{frame}
\note{
what the slide would have said re political ideology debate in
political science:\\ 
  \begin{enumerate}
