...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file 'acorn03.csv': No such file or directory}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in treat\_group\_mean(.Z = acorn\_data\_subset\$z, .y = acorn\_data\_subset\$vote03): object 'acorn\_data\_subset' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(null\_test\_stat\_dist\$null\_test\_stat): object 'null\_test\_stat\_dist' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean((null\_test\_stat\_dist\$null\_test\_stat - mean(null\_test\_stat\_dist\$null\_test\_stat))\textasciicircum{}2): object 'null\_test\_stat\_dist' not found}}\begin{alltt}
\hlstd{sim_var}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'sim\_var' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(acorn\_data\_subset\$vote03): object 'acorn\_data\_subset' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'acorn\_data\_subset' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(acorn\_data\_subset\$vote03): object 'acorn\_data\_subset' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean((acorn\_data\_subset\$vote03 - mean(acorn\_data\_subset\$vote03))\textasciicircum{}2): object 'acorn\_data\_subset' not found}}\begin{alltt}
\hlkwd{cbind}\hlstd{(pop_mean,}
      \hlstd{pop_var)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cbind(pop\_mean, pop\_var): object 'pop\_mean' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fpc\_var\_sample\_mean(.y = acorn\_data\_subset\$vote03, .n\_t = sum(acorn\_data\_subset\$z)): object 'acorn\_data\_subset' not found}}\begin{alltt}
\hlstd{fpc_var}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'fpc\_var' not found}}\begin{alltt}
