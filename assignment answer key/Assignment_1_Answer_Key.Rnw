...
\begin{align*}
\left|p_{\text{approx}} - p_{\text{exact}}\right| & \leq 0.005 \leq \frac{1}{\sqrt{n_{\text{sims}}}} \\
...
To add more insight, let's derive these this expression for $\Var\left[n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y}\right]$:

\begin{align*}
\Var\left[n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y}\right] \\
& \equiv \E\left[\left(n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y} - \E\left[n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y}\right]\right)^2\right] \\
& \equiv \E\left[\left(n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y} - \E\left[n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y}\right]\right)\left(n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y} - \E\left[n_t^{-1}\mathbf{Z}^{\prime}\mathbf{y}\right]\right)\right] \\
& \equiv \E\left[n_t^{-1}\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)n_t^{-1}\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)\right] \\
& \equiv \E\left[n_t^{-1}n_t^{-1}\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)\right] \\
& \equiv \E\left[\left(n_t^{-1}\right)^2\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)^2\right] \\
& \equiv \left(n_t^{-1}\right)^2 \E\left[\left(\mathbf{Z}^{\prime}\mathbf{y} - \E\left[\mathbf{Z}^{\prime}\mathbf{y}\right]\right)^2\right] \\
& \equiv \left(n_t^{-1}\right)^2 \Var\left[\mathbf{Z}^{\prime}\mathbf{y}\right] \\
& \equiv \left(n_t^{-1}\right)^2 \Var\left[\sum \limits_{i = 1}^n Z_i y_i\right] \\
& \equiv \left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \Var\left[Z_i \right] + \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \Cov\left[Z_i, Z_j\right]\right) \\
\end{align*}

We know that $\Cov\left[Z_i, Z_j\right] = \E\left[Z_iZ_j\right] - \E\left[Z_i\right]\E\left[Z_j\right]$. In Question \ref{qu: 5}, we showed that $\E\left[Z_i\right] = \E\left[Z_j\right] = \frac{n_t}{n}$. But to derive $\E\left[Z_iZ_j\right]$, we need to consider the probability that both unit $i$ and unit $j$ are assigned to treatment. Following the same logic from Question \ref{qu: 5}, that probability is as follows:
\begin{align*}
\E\left[Z_iZ_j\right] \\
& \equiv \frac{{n - 2 \choose n_t - 2}}{{n \choose n_t}} \\
& \equiv \frac{\left(\frac{\left(n - 2\right)!}{n_c!\left(n_t - 2\right)!}\right)}{\left(\frac{n!}{n_c!n_t!}\right)} \\
& \equiv \frac{{n - 2 \choose n_t - 2}}{{n \choose n_t}} \\
& \equiv \frac{\left(n - 2\right)!}{n_c!\left(n_t - 2\right)!}\left(\frac{n_c!n_t!}{n!}\right) \\
& \equiv \frac{\left(n - 2\right)\left(n - 3\right) \dots 1}{n_c\left(n_c - 1\right) \dots 1 \left(n_t - 2\right)\left(n_t - 3\right) \dots 1} \frac{n_c\left(n_c - 1\right) \dots 1 n_t \left(n_t - 1\right) \dots 1}{n\left(n - 1\right) \dots 1} \\
\\
& \equiv \frac{\left(n - 2\right)\left(n - 3\right) \dots 2 n_c\left(n_c - 1\right) \dots 2 n_t \left(n_t - 1\right) \dots 2}{n_c\left(n_c - 1\right) \dots 2 \left(n_t - 2\right)\left(n_t - 3\right) \dots 2 n\left(n - 1\right) \dots 2} \\
\\
& \equiv \frac{n_t \left(n_t - 1\right)}{n \left(n - 1\right)} & 
\end{align*}

We can therefore express $\Cov\left[Z_i, Z_j\right] = \E\left[Z_iZ_j\right] - \E\left[Z_i\right]\E\left[Z_j\right]$ as $\frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \frac{n_t}{n}\frac{n_t}{n} = \frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t}{n}\right)^2 = \frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t^2}{n^2}\right)$. 

Now let's further simplify $\frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t^2}{n^2}\right)$. To do so, we need to find an expression that is a multiple of $n\left(n - 1\right)$ and $n^2$. The expression $n^2\left(n - 1\right)$ is a common multiple of both $n\left(n - 1\right)$ and of $n^2$, since multiplying $n\left(n - 1\right)$ by $n$ yields $n^2\left(n - 1\right)$ and multiplying $n^2$ by $\left(n - 1\right)$ also yields $n^2\left(n - 1\right)$.

Now we can adjust the fractions in $\frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t^2}{n^2}\right)$ based on the common denominator $n^2\left(n - 1\right)$. We can do so by multiplying each numerator by the same amount needed to multiply its respective denominator to turn it into the common multiple of $n^2\left(n - 1\right)$. Therefore, we can rewrite $\frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t^2}{n^2}\right)$ as follows:
\begin{align*}
\frac{n_t\left(n_t - 1\right)}{n\left(n - 1\right)} - \left(\frac{n_t^2}{n^2}\right) \\
& \equiv \frac{n_t \left(n_t - 1\right)n}{n^2\left(n - 1\right)} - \frac{n_t^2\left(n - 1\right)}{n^2 \left(n - 1\right)} \\
& \equiv \frac{n_t n\left(n_t - 1\right)}{n^2\left(n - 1\right)} - \frac{n_t^2\left(n - 1\right)}{n^2 \left(n - 1\right)} \\
& \equiv \frac{n_t n\left(n_t - 1\right) - n_t^2\left(n - 1\right)}{n^2 \left(n - 1\right)} \\
& \equiv \frac{n n_t^2 - nn_t - n n_t^2 + n_t^2}{n^2 \left(n - 1\right)} \\
& \equiv \frac{n n_t^2 - n n_t^2 + n_t^2 - nn_t}{n^2 \left(n - 1\right)} \\
& \equiv \frac{n_t^2 - nn_t}{n^2 \left(n - 1\right)} \\
& \equiv \frac{-nn_t + n_t^2}{n^2 \left(n - 1\right)} \\
& \equiv \frac{-n_t \left(n - n_t\right)}{n^2 \left(n - 1\right)} \\
& \equiv \frac{-n_t \left(n - n_t\right)}{n n \left(n - 1\right)} \\
& \equiv \frac{-n_t \left(n - n_t\right)}{1} \frac{1}{n}  \frac{1}{n \left(n - 1\right)} \\
& \equiv \frac{-n_t \left(n - n_t\right)}{n}\frac{1}{n \left(n - 1\right)} \\
& \equiv \frac{\left(\frac{-n_t \left(n - n_t\right)}{n}\right)}{n \left(n - 1\right)} \\
\end{align*}
\begin{align*}
& \equiv \frac{-n_t\left(\frac{n - n_t}{n}\right)}{n \left(n - 1\right)} \\
& \equiv \frac{-n_t\left(\frac{n}{n} - \frac{n_t}{n}\right)}{n \left(n - 1\right)} \\
& \equiv \frac{-n_t\left(1 - \frac{n_t}{n}\right)}{n \left(n - 1\right)} \\
& \equiv -\frac{1}{n - 1}\left(1 - \frac{n_t}{n}\right)\frac{n_t}{n}  \\
\end{align*}

We have just shown that $\Cov\left[Z_i, Z_j\right] = \E\left[Z_iZ_j\right] - \E\left[Z_i\right]\E\left[Z_j\right] = -\frac{1}{n - 1}\left(1 - \frac{n_t}{n}\right)\frac{n_t}{n}$. Therefore, we can express $\left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \Var\left[Z_i \right] + \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \Cov\left[Z_i, Z_j\right]\right)$ as follows:

\begin{align*}
\left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \Var\left[Z_i \right] + \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \Cov\left[Z_i, Z_j\right]\right) \\
\equiv \left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \Var\left[Z_i \right] + \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j -\frac{1}{n - 1}\left(1 - \frac{n_t}{n}\right)\frac{n_t}{n}\right) && \text{Substituting for } \Cov\left[Z_i, Z_j\right] \\
\equiv \left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \Var\left[Z_i \right] - \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \frac{1}{n - 1}\left(1 - \frac{n_t}{n}\right)\frac{n_t}{n}\right) && \text{Distributive Property} \\ 
\equiv \left(n_t^{-1}\right)^2 \left(\sum \limits_{i = 1}^n y_i^2 \frac{n_t}{n}\left(1 - \frac{n_t}{n}\right) - \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \frac{1}{n - 1}\left(1 - \frac{n_t}{n}\right)\frac{n_t}{n}\right) && \text{Substitute for } \Var\left[Z_i\right] \\ 
\equiv \frac{1}{n_t^2} \frac{n_t}{n} \left(1 - \frac{n_t}{n}\right) \left(\sum \limits_{i = 1}^n y_i^2 - \frac{1}{n - 1} \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \text{Distributive Property} \\
\equiv \frac{1}{n_t^2}\frac{n_t}{n} \left(1 - \frac{n_t}{n}\right) \left(\sum \limits_{i = 1}^n y_i^2 - \frac{1}{n - 1} \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \text{Commutativity of Multiplication} \\
\equiv \frac{n_t}{n_t^2 n} \left(1 - \frac{n_t}{n}\right) \left(\sum \limits_{i = 1}^n y_i^2 - \frac{1}{n - 1} \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \text{Multiplication of Fractions} \\
\end{align*}
\begin{align*}
\equiv \frac{1}{n_t} \frac{1}{n} \left(1 - \frac{n_t}{n}\right) \left(\sum \limits_{i = 1}^n y_i^2 - \frac{1}{n - 1} \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \text{Simplify} \\
\equiv \frac{n - n_t}{n_tn^2} \left(\sum \limits_{i = 1}^n y_i^2 - \frac{1}{n - 1} \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) &&  \\
\equiv \frac{n - n_t}{n_tn^2}\frac{1}{n - 1} \left(\left(n - 1\right)\sum \limits_{i = 1}^n y_i^2 - \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \text{Distributive Property and } \frac{n-1}{n-1} = 1 \\
\equiv \frac{1}{n_t} \left(1 - \frac{n_t}{n}\right)\frac{1}{n\left(n - 1\right)} \left(\left(n - 1\right)\sum \limits_{i = 1}^n y_i^2 - \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \\
\end{align*}

For the next step, we will invoke the proposition that $\sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j \equiv \left(\sum \limits_{i = 1}^n y_i\right)^2 + \sum \limits_{i = 1}^n y_i^2$. Let's prove this proposition by induction.

A proof by induction is very useful when proving a proposition about a well-ordered set. The proof proceeds in two parts: 
\begin{enumerate}
\item \textbf{Base Step}: Prove the proposition for the first element in the well-ordered set. For example, if the set is that of natural numbers, $\N$, then one would prove the proposition for $n = 1$.
\item \textbf{Inductive Step}: Prove that if the proposition is \textit{assumed} to be true for any element in the well-ordered set, then the proposition must be true for the next element in that set.
\end{enumerate}
Therefore, if we prove that the proposition is true for the base case, then by the inductive step, the proposition must also be true for the second element in the set. And if the proposition is true for the second element, then the inductive step ensures that the proposition must also be true for the third element, and so on . . .

\begin{enumerate}
\item \textbf{Base Step}: Because we have two summation operators, which are well-defined only if $n \geq 2$, let the base step be the case in which $n = 2$. 
\begin{align*}
\left(\sum \limits_{i = 1}^2 y_i\right)^2 \\
& \equiv \left(y_1 + y_2\right)^2 \\
& \equiv \left(y_1 + y_2\right)\left(y_1 + y_2\right) \\
& \equiv y_1^2 + y_2 y_1 + y_1 y_2 + y_2^2 \\
& \equiv y_1 y_2 + y_2 y_1 + y_1^2 + y_2^2 \\
& \equiv \sum \limits_{i = 1}^2 \sum \limits_{j \neq i}^2 y_i y_j + \sum \limits_{i = 1}^2 y_i^2
\end{align*}

\item \textbf{Induction Step}: Now let's prove that if the proposition, $\left(\sum \limits_{i = 1}^n y_i\right)^2 \equiv \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j + \sum \limits_{i = 1}^n y_i^2$, for $n$ is true, then it must also be true for $n+1$:

\textit{Assume} that $\left(\sum \limits_{i = 1}^n y_i\right)^2 \equiv \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j + \sum \limits_{i = 1}^n y_i^2$. Then,
\begin{align*}
\left(\sum \limits_{i = 1}^{n+1} y_i\right)^2 \\
& \equiv y_{n+1}^2 +  \\
& \equiv \\
& \equiv \sum \limits_{i = 1}^{n+1} \sum \limits_{j \neq i}^{n+1} y_i y_j + \sum \limits_{i = 1}^{n+1} y_i^2
\end{align*}
...
\begin{align*}
\equiv \frac{1}{n_t} \left(1 - \frac{n_t}{n}\right)\frac{1}{n\left(n - 1\right)} \left(\left(n - 1\right)\sum \limits_{i = 1}^n y_i^2 - \sum \limits_{i = 1}^n \sum \limits_{j \neq i}^n y_i y_j\right) && \\
\equiv \frac{1}{n_t} \left(1 - \frac{n_t}{n}\right)\frac{1}{n\left(n - 1\right)} \left[ \sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2  + \sum \limits_{i = 1}^n y_i^2 \right] && \\
\equiv \frac{1}{n_t} \left(1 - \frac{n_t}{n}\right)\frac{1}{n\left(n - 1\right)} \left[n \sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2 \right] && \\
\equiv \frac{1}{n_t} \frac{n - n_t}{n}\frac{1}{n\left(n - 1\right)} \left[n \sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2 \right] && \\
\equiv \frac{1}{n_t} \frac{n - n_t}{n}\frac{1}{n}\frac{1}{\left(n - 1\right)} \left[n \sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2 \right] && \\
\equiv \frac{1}{n_t} \frac{n - n_t}{n}\frac{1}{\left(n - 1\right)} \frac{\left[n \sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2 \right]}{n} && \\
\equiv \frac{1}{n_t} \frac{n - n_t}{n}\frac{1}{\left(n - 1\right)}\frac{n}{1} \frac{\left[\sum \limits_{i = 1}^{n} y_i^2 - \left(\sum \limits_{i = 1}^n y_i \right)^2 \right]}{n} && \\
\equiv \frac{1}{n_t} \frac{n - n_t}{n}\frac{1}{\left(n - 1\right)}\frac{n}{1} \sigma_y^2 && \\
\equiv \frac{n - n_t}{n}\frac{1}{\left(n - 1\right)}\frac{n}{1} \frac{\sigma_y^2}{n_t} && \\
\equiv \frac{n\left(n - n_t\right)}{n\left(n - 1\right)}\frac{\sigma_y^2}{n_t} && \\
\equiv \frac{\left(n - n_t\right)}{\left(n - 1\right)}\frac{\sigma_y^2}{n_t} && \\
\end{align*}
