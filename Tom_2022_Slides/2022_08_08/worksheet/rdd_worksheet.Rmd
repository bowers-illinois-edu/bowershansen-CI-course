...
bibliography: rdd_bibliography.bib
biblio-style: apsr
editor_options: 
...
available for download \href{http://sekhon.berkeley.edu/rep/RDReplication.zip}{here}. But we read it directly below.] \citet{caugheysekhon2011} engage in a debate whose
...
\citet{saleshansen2020}, however, propose robust regression, which is less sensitive to violations of the regression model's assumptions --- still removing linear trend here.
...
rdest1 <- RDestimate(DPctNxt~DifDPct,
                     data = rdd_data,
                     se.type = "HC3")
summary(rdest1)
