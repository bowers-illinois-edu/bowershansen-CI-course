...
The null hypothesis of no effect among compliers under excludability (only a complier in the treatment group can have a causal effect), no defiers
...
So: a regular test of the sharp null of no effects **is also a test of the sharp
null of no effects among compliers** (under the assumptions of no defiers,
non-zero compliers, exclusion, and no interference).
