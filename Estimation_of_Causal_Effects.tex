...
Now we are repeatedly estimating the ATE under 1000 treatment assignment permutations in order to assess unbiasedness. Which two quantities would we like to compare in order to assess whether or not the difference-in-means estimator is unbiased?
