...
```{r}
## https://cran.r-project.org/web/packages/senstrat/index.html
library(senstrat)

library(sensitivityfull)
senfm(-respmat,treated1=rep(TRUE,nrow(respmat)))
senmv(-respmat)
...
See perhaps this for our approach: https://cran.r-project.org/web/packages/BiasedUrn/index.html
...
this term. And we see that this term is strongly  related whether the
