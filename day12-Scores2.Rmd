...
```{r xbmh, echo=TRUE}
xbMh <- xBalance(nhTrt ~ nhAboveHS + nhPopD + HomRate03, strata = list(unstrat = NULL, fm1=~fm1, fmMh = ~fmMh, fmMh1 = ~fmMh1, fmMh2=~fmMh2,pmMh1=~pmMh1), report = "all", data = meddat)
xbMh$overall
## xbMh$results
...
xb5 <- xBalance(balfmla,
  strata = list(unstrat=NULL,fmMh = ~fmMh, fmMh2=~fmMh2,fmPs = ~fmPs),
